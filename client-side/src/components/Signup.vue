<template>
  <div class="sign-form">
    <h3 style="text-align: center; font-weight: bold">👾 Create a Game 👾</h3>
    <br />
...
export default {
  ...
  data() {
    return {
      ...
      set: [
        ...
        {
          text: "Modified Fibonacci: (0, '½', 1, 2, 3, 5, 8, 13, 20, 40, 100, '?')",
          value: [0, 0.5, 1, 2, 3, 5, 8, 13, 20, 40, 100, "?"],
        },
      ],
      showOption: [
        { text: "Select One", value: null },
  ...
  methods: {
    ...
    onReset(event) {
      event.preventDefault();
      (this.form.gameName = ""), (this.form.numberSet = null);
